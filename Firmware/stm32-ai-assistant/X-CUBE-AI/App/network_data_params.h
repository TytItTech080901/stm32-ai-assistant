...
#define AI_NETWORK_DATA_ACTIVATIONS_SIZES \
  { 20736, }
#define AI_NETWORK_DATA_ACTIVATIONS_SIZE     (20736)
#define AI_NETWORK_DATA_ACTIVATIONS_COUNT    (1)
#define AI_NETWORK_DATA_ACTIVATION_1_SIZE    (20736)



#define AI_NETWORK_DATA_WEIGHTS_SIZES \
  { 88456, }
#define AI_NETWORK_DATA_WEIGHTS_SIZE         (88456)
#define AI_NETWORK_DATA_WEIGHTS_COUNT        (1)
#define AI_NETWORK_DATA_WEIGHT_1_SIZE        (88456)
